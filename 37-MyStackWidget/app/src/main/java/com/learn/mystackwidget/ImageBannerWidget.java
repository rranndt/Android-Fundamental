...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.learn.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.learn.EXTRA_ITEM";
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setEmptyView(R.id.stackView, R.id.stackView);
