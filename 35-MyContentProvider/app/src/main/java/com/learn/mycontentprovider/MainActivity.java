...
import com.learn.mycontentprovider.adapter.NoteAdapter;
import com.learn.mycontentprovider.db.DatabaseContract;
import com.learn.mycontentprovider.db.NoteHelper;
import com.learn.mycontentprovider.entity.Note;
import com.learn.mycontentprovider.helper.MappingHelper;
...
//        noteHelper.open();
        ...
        getContentResolver().registerContentObserver(DatabaseContract.NoteColumn.CONTENT_URI, true, myObserver);
...
//    }
    ...
    private static class LoadNotesAsync extends AsyncTask<Void, Void, ArrayList<Note>> {
        ...
        private LoadNotesAsync(Context context, LoadNotesCallback loadNotesCallback) {
        ...
        protected ArrayList<Note> doInBackground(Void... voids) {
            ...
            Cursor dataCursor = context.getContentResolver().query(DatabaseContract.NoteColumn.CONTENT_URI, null, null, null, null);
