...
public class NotificationBroadcastReceiver extends BroadcastReceiver {
    ...
    private static final String KEY_NOTIFICATION = "key_notification_id";
    ...
    public static Intent getReplyMessageIntent(Context context, int notificationId, int messageId) {
        ...
        intent.putExtra(KEY_NOTIFICATION, notificationId);
    ...
    public void onReceive(Context context, Intent intent) {
        if (REPLY_ACTION.equals(intent.getAction())) {
            ...
            int notifyId = intent.getIntExtra(KEY_NOTIFICATION, 1);
