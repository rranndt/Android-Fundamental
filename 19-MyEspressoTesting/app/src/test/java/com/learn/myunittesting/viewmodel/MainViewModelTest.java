...
public class MainViewModelTest {
    ...
    private final double dummySurfacerArea = 396.0;
    ...
    public void testSurfaceArea() {
        ...
        assertEquals(dummySurfacerArea, volume, 0.0001);
    }
    ...
    public void testMockSurface() {
        when(mainViewModel.getSurfaceArea()).thenReturn(dummySurfacerArea);
        double volume = mainViewModel.getSurfaceArea();
